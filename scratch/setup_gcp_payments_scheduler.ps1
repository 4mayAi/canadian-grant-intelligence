...
Write-Host "Enabling cloudscheduler.googleapis.com API..." -ForegroundColor Cyan
...
$workflow = "daily_payments_scraper.yml"
...
$jobName = "daily-payments-scraper-trigger"
$schedule = "0 13 * * *" # 1:00 PM EDT (17:00 UTC)
