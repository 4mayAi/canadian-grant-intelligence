...
$workflow = "update_hub_anchors.yml"
...
$jobName = "monthly-mining-hub-anchors-update-trigger"
$schedule = "0 0 1 * *" # Midnight on the 1st of every month UTC

Write-Host "Configuring Google Cloud Scheduler job: $jobName for $schedule UTC..." -ForegroundColor Cyan
