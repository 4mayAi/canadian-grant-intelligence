...
print(f"Scraping Verbatim HTML Titles across {len(inventory)} FSC publication pages...")
    ...
    try:
        ...
        with urllib.request.urlopen(req, timeout=8) as resp:
            ...
            if og_match:
                ...
                # Clean Yoast suffix (e.g. " - Future Skills Centre...")
...
def main():
    ...
    with open(js_path, "w", encoding="utf-8") as f:
        ...
        f.write(f'  sha256_verification_status: "100% VERBATIM HTML TITLES & DEEP LIVE URLS (0% 404)",\n')
