...
class GeminiClient:
    ...
    def generate_linkedin_post(
        ...
        - Anti-Stiffness Negative Constraints:
          * NEVER use first-person pronouns (such as "we", "our", "us", "we offer", or "our team"). Write strictly in objective third-person executive journalism (e.g. "Enterprise operators should establish...", "Advisory practices can structure..."). Do NOT invent arbitrary dollar fees or repetitive pricing for advisory services. Focus on deliverable scope, operational strategy, and commercial capability.
