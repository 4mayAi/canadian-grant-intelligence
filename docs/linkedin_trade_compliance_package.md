...
```mermaid
graph TD
    A["Canadian Trade & Supply Chain Intelligence"] --> B["Border Compliance & Tariffs"]
    A --> C["Trade Policy & Sanctions"]
    A --> D["Trade Remedies & Competition"]
    A --> E["Logistics & Infrastructure"]

    B --> B1["CBSA Customs Notices & Valuations"]
    B --> B2["CARM Mandatory RPP Bonding"]
    B --> B3["Steel, Aluminum & EV Surtaxes"]

    C --> C1["Bill C-35 Forced Labour Reverse Onus"]
    C --> C2["SEMA & Autonomous Sanctions"]
    C --> C3["Transshipment Evasion Screening"]

    D --> D1["CITT Anti-Dumping Injury Findings"]
    D --> D2["Bill C-59 Anti-Greenwashing Claims"]
    D --> D3["Federal Procurement Bid Challenges"]

    E --> E1["CanadaBuys Warehousing & Drayage RFPs"]
    E --> E2["CTA Rail Corridor Adjudications"]
    E --> E3["Bill C-26 Critical Infrastructure Cyber"]
```
